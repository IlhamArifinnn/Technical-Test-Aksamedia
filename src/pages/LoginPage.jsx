      ...
      <div className="w-full md:w-[80%] lg:w-[60%] flex flex-col md:flex-row justify-around gap-6 md:gap-10 p-6 md:p-8 bg-gray-100 dark:bg-gray-800 rounded-xl shadow-lg">
        ...
        <div className="w-full md:w-1/2">
          ...
          <form className="mt-3 space-y-6" onSubmit={handleLogin}>
            ...
            <button
              type="submit"
              className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#00baff] hover:bg-[#15b9be] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 cursor-pointer"
            >
              Sign In
            </button>
          </form>
